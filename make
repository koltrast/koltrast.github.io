...
<style>body{text-align:center;overflo:w-y:scroll;font:calc(0.75em + 1vmin)}pre pre{text-align:left;display:inline-block}img{max-width:57ch;display:block;height:auto;width:100%}@media(prefers-color-scheme:dark){body{background:#000;color:#fff}a{color:#6CF}}</style>
<pre>

<a href=/><b>&rarr; KOLTRAST</b></a>  <a href=/news.html>News</a>  <a href=/artworks.html>Artworks</a>  <a href=/writings.html>Writings</a>  <a href=/repository.html>Repository</a>  <a href=/blog.html>Blog</a>  <a href=/about.html>About</a> 
